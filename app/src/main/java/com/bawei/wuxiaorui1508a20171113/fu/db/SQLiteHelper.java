...
//
package com.bawei.wuxiaorui1508a20171113.fu.db;
...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String mDatabasename = "filedownloader1";
	private static CursorFactory mFactory = null;
	private static final int mVersion = 1;
	public static final String TABLE_NAME = "downloadinfo1"; //文件下载信息数据表名称
